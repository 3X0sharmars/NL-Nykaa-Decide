...
|---|---:|---:|---:|---:|---:|---:|
| `gemini-3-flash-preview` | 5 | 10/11 | 0 | 1 | 0 | 0 |
| `gemini-3-flash-preview` | 10 | 0/11 | 0 | 11 | 0 | 0 |

## `gemini-3-flash-preview` batch 5

Transport failures: 1 — e.g. transient error persisted after 4 attempts: ClientError HTTP 429: 429 RESOURCE_EXHAUSTED. {'error': {'code': 429, 'message': 'You exceeded your current quota, p

## `gemini-3-flash-preview` batch 10
